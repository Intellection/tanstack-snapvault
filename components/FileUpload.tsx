        ...
        try {
          ...
          const progressInterval = setInterval(() => {
            setUploadingFiles((prev) => {
              const updated = [...prev];
              if (
                updated[uploadingFileIndex] &&
                updated[uploadingFileIndex].progress < 90
              ) {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Upload JPG, PNG, GIF, SVG images and TXT, MD, CSV files
            </p>
            <button
          ...
          <div className="text-sm text-gray-500">
            ...
            <p>Supported formats: JPG, PNG, GIF, SVG, TXT, MD, CSV</p>
          </div>
        </div>
      </div>
              ...
              >
                ...
                {uploadingFile.status === "success" && uploadingFile.result && (
                  <div className="mt-2 text-sm text-green-600">
                    File uploaded successfully! Access at:{" "}
                    {uploadingFile.result.url}
                  </div>
                )}
              </div>
            ))}
